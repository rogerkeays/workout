...
def lightly_row(meter=4, tempo=90, tonic=49):
  piece(27, "lightly-row", locate("27.lightly-row.mp3"), tempo,
    ...
    rhythm  = "|123|123 |1234|123 |1234|1234 |1234|123 |1234|123 |1234|123|1",
    strings = "|12=|=== |====|1== |=2==|==== |==1=|=== |2===|=== |====|===|=",
    bowing  = "|535|353 |5353|535 |3535|3535 |3535|353 |5353|535 |3535|353|5",
    shapes  = "|NW=|=== |====|N== |=W==|==== |==N=|W== |====|=== |====|===|=",
...
def ponies(meter=3, tempo=95, tonic=42):
  piece(34, "ponies", locate("34.ponies.mp3"), tempo,
    ...
    strings = "|3=|=|==|= |2=|=3==|=|= |4=|=|3==|=|=",
    bowing  = "|53|5|35|3 |53|5353|5|3 |53|5|354|3|5",
    shapes  = "|G=|=|==|= |P=|=G==|=|= |==|=|===|=|=",
    bases   = "|2=|=|==|= |1=|=2==|=|= |==|=|===|=|=",
...
def musette(meter=4, tempo=120, tonic=42):
  piece(35, "musette", locate("35.musette.mp3"), tempo,
    ...
    bowing  = "|53535|35353 |53534|5353 |53534|5353 |535353|535 |353535|353 |545353|5|3",
    shapes  = "|W====|===== |=====|==== |=====|==== |======|=== |======|=== |======|=|=",
    bases   = "|2====|===== |=====|==== |=====|==== |======|=== |======|=== |======|=|=",
