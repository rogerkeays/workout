...
def violin(number, name, video_id, meter, tempo, tonic, sections, speeds=[0.5, 1.0]):
  process_piece(Piece("violin", number, name, video_id, meter, tempo, tonic, sections, speeds),
