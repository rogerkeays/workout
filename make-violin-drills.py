...
tempo = 90
goal("baby-steps", locate("1002.baby-steps.mp3"), tempo)
...
tempo = 110
goal("the-car-trip", locate("1003.the-car-trip.mp3"), tempo)
single_string_crossings(tempo, "m", "elbow", "detache", "ss")
...
tempo = 110
goal("aeroplane-games", locate("1004.aeroplane-games.mp3"), tempo)
single_string_crossings(tempo, "m", "elbow", "detache", "ss")
...
tempo = 90
goal("lightly-row", locate("1024.lightly-row.mp3"), tempo)
