...
voice(2002, "king", "KwXNHdfjh30", 4, 62.5, "49", [ # fridays
  ...
  section("X", "alcove", [
    ...
    phrase(57.55, "kick")       # time for a swift kick
  ]),

  # bar
  section("C", "dishwashing-sink", [
    phrase(61.41, "town"),      # you see, i own this town
    phrase(64.30, "best"),      # you best not come around
    phrase(67.17, "cool"),      # if you wanna get by, then cool it down
  ...
  # beergarden
  section("V", "group-table", [
    phrase(91.59, "attention"), # you wanted attention
    phrase(95.50, "mention"),   # and did i mention?
  ...
  section("X", "small-table", [
    ...
    phrase(148.36, "with-me")   # if you get with me
  ]),
  ...
  # middle
  section("M", "upstairs", [
    phrase(183.70, "break-me"), # you can't break me
