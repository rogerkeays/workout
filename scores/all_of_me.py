...
process_piece(Piece("all-of-me", 4, 126, "48", [
  ...
  Section("BEDROOM", "V3", [
    ...
    phrase("beating", notes("""
      ...
      e= 0 3=C4 4=== M
      4= = ==== 6=== a-
      o2 2 2=W1 26== ROUND"""), 122.55, 128.17),
    phrase("mood", notes("""
      u= 2 21W1 6=LM through
      3= 4 ===2 2=== E-
      e= 2 ===1 4=== VE-
      4= = ==== 6=== ry
      o2 9 3=C2 26== MOOD"""), 128.17, 130.19)
  ]),
  Section("GARAGE", "V4", [
    phrase("DOWNFALL", notes("""
      p= 7 21W4 2=LM YOU'RE
      e= 4 ===2 4=== my
      o= = ==== 2=== DOWN-
      a= 0 3=C4 6=== fall,
      3= 7 2=W= 2=== YOU'RE
    ...
    phrase("distraction", notes("""
      ...
      e= 2 ===1 2=== THM
      4= 4 ===2 4=== n
      o2 9 3=C2 26== BLUES"""), 133.97, 137.69),
